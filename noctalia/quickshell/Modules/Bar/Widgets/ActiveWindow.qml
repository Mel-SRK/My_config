...
Item {
  ...
  // Use a standard themed fallback icon. "user-desktop" is missing on this system
  // and causes repeated icon lookup warnings while focus changes.
  readonly property string fallbackIcon: "file:///usr/share/icons/Adwaita/16x16/mimetypes/application-x-executable.png"
