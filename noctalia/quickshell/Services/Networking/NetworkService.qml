...
Singleton {
  ...
  Timer {
    ...
    // Network changes are already event-driven by nmcli monitor; a 60s fallback keeps
    // connectivity status fresh without waking nmcli every 15s in the background.
    interval: 60000
